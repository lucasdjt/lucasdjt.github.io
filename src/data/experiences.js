const experiences = [
		...
		projects: [
			{
				...
				title: 'Hagar.io',
				description:
					'Projet réalisé pendant le S4 utilisant JavaScript, Node.js et Socket.io',
			},
			{
				anchor: 'dwidder',
				title: 'Dwidder',
				description:
					'Projet réalisé pendant le S4 utilisant JavaEE, PostgreSQL et Tomcat.',
			},
			{
				anchor: 'classification',
				title: 'Application de Classification',
				description:
					'Projet réalisé pendant le S3 utilisant Java, JavaFX, Modèle MVC et les fichiers CSV.',
			},
			{
				anchor: 'miniagile',
				title: 'Projet en méthodologie Agile',
				description:
					'Projet réalisé pendant le S3 en Java suivant la méthodologie Agile.',
			},
		],
	...
	},
	{
		...
		skills: [
			...
			{ anchor: 'm365', title: 'Gestion de PC Windows, installation et configuration' },
			...
			{ anchor: 'outils-production', title: `Utilisation d'Excel, de l'Active Directory, de CMBD et de Microsoft365 pour répertorier les données et utilisation de Markdown pour rédiger un guide complet. Utilisation de Draw.io pour Power Automates.` },
		],
		projects: [],
