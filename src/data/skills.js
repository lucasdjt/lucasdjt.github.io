...
const techStack = [
	{
		id: 'java',
		title: 'Java',
		description: `Java est l'un des langages de programmation les plus populaires et polyvalents. 
	...
	},
	{
		...
		description: `J'ai acquis une solide expertise dans le développement d'applications Java, 
	...
	},
	{
		...
		description: `J'ai développé de solides compétences en JavaEE, me permettant de concevoir et d'implémenter 
	...
	},
	{
		id: 'dev-web',
		title: 'HTML, CSS, PHP',
		description: `Je maîtrise les fondamentaux du développement web, notamment HTML, CSS et PHP, qui ont été largement 
	...
	},
	{
		...
		description: `Je maîtrise les fondamentaux de JavaScript et de TypeScript, ce qui me permet de développer des applications 
	...
	},
	{
		id: 'react',
		title: 'React',
		description: `J'ai acquis des compétences de base en ReactJS de manière autodidacte, ce qui m'a permis de comprendre 
	...
	},
	{
		id: 'angular',
		title: 'Angular',
		description: `Je suis actuellement en train d'apprendre cette technologie qu'est Angular, une des frameworks de JS les 
	...
	},
	{
		id: 'nodejs',
		title: 'Node.js, NPM',
		description: `J'utilise Node.js et son gestionnaire de paquets par défaut, NPM, pour installer et intégrer des bibliothèques, 
	...
	},
	{
		id: 'socketio',
		title: 'Socket.io',
		description: `J'ai appris et utilisé Socket.IO lors d'un de mes projets en JavaScript, où j'ai mis en œuvre et géré des 
	...
	},
	{
		id: 'api',
		title: 'API REST',
		description: `J'ai appris à utiliser et intégrer une API REST, permettant à mon réseau social 
	...
	},
	{
		id: 'c',
		title: 'C',
		description: `J'ai acquis de solides bases en langage C, notamment dans la gestion de la mémoire dynamique 
	...
	},
	{
		id: 'arduino',
		title: 'Arduino',
		description: `J'ai acquis des compétences en Arduino, l'un des premiers langages grâce auquel j'ai appris la programmation, 
	...
	},
	{
		id: 'python',
		title: 'Python',
		description: `Je suis actuellement en train d'apprendre cette technologie qu'est Python, 
	...
	},
	{
		...
		description: `Je maîtrise Git et l'utilise dans tous mes projets, ce qui me permet de gérer les différentes versions, 
	...
	},
	{
		id: 'conteneurs',
		title: 'Docker, Podman',
		description: `Je maîtrise les bases de la virtualisation via des conteneurs, en utilisant des outils tels que Docker et Podman. 
	...
	},
	{
		id: 'linux',
		title: 'Linux',
		description: `J'ai développé des compétences solides en administration système, en réseau, et en scripting shell, 
	...
	},
	{
		id: 'windows',
		title: 'Windows',
		description: `J'ai aussi acquis des compétences sur le système d'exploitation Windows, notamment dans l'utilisation 
	...
	},
	{
		...
		description: `Je maîtrise une variété d'outils de production, adaptés à divers besoins professionnels et créatifs, 
	...
	},
	{
		...
		description: `J'utilise actuellement Visual Studio Code, un IDE que je maîtrise particulièrement. 
	...
	},
	{
		...
		description: `J'ai acquis des compétences en développement mobile en utilisant Android Studio, 
	...
	},
	{
		...
		description: `J'ai acquis des compétences solides en gestion de projet grâce à la méthodologie Agile. 
	...
	},
	{
		...
		description: `J'ai appris à réaliser des projets sous une architecture MVC (Modèle-Vue-Contrôleur), 
	...
	},
	{
		...
		description: `J'ai acquis des compétences solides dans l'utilisation du modèle TDD (Test Driven Development) 
...
const knowledges = [
	{
		title: 'Créatif',
		description: `Ma créativité est l'un de mes atouts majeurs dans le développement. 
        J'aime trouver de nouvelles idées pour concevoir des projets innovants.`,
	},
	{
		title: 'Logique',
		description: `J'aborde les problèmes de manière logique, ce qui constitue une force en algorithmique 
        et en résolution de problèmes complexes.`,
	},
	{
		title: 'Autonome',
		description: `Je suis également capable de travailler de manière autonome, en recherchant par moi-même 
        les informations nécessaires pour avancer efficacement.`,
	},
	{
		title: 'Curieux',
		description: `Je m'informe régulièrement et me tiens à jour des avancées dans le domaine de l'informatique 
        pour ne pas être obsolète.`,
	},
	{
		title: 'Gestion',
		description: `Je sais travailler en équipe, coopérer, communiquer efficacement et écouter attentivement. 
