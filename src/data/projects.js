...
const projects = [
	{
		id: 'booktaplace',
		path: `${PATH_LOGO}booktaplace/`,
		title: 'BookTaPlace',
		github: 'https://github.com/lucasdjt/booktaplace',
		date: '23/01/2026',
		description: `Projet en 3ème année de BUT Informatique consistant à développer une application web de réservation de créneaux (planning) configurable via fichiers de propriétés. L’application suit une architecture MVC avec Spring Boot et propose authentification, gestion des réservations (dont filtres passé/futur), interface d’administration et API REST (JSON/XML). Projet réalisé en binôme.`,
		state: 'completed',
		experiences: 'but-info',
		screenshots: [],
		skills: [
			{ anchor: 'java', title: 'Java' },
			{ anchor: 'spring', title: 'Spring Boot' },
			{ anchor: 'spring', title: 'Spring Data JPA (Hibernate)' },
			{ anchor: 'api', title: 'API REST (JSON/XML)' },
			{ anchor: 'css', title: 'TailwindCSS' },
			{ anchor: 'mvc-model', title: 'Architecture MVC Web' },
			{ anchor: 'git', title: 'Git (GitHub/GitLab)' },
		],
		oldVersions: [],
	},
	{
		...
		title: 'Emulateur RISC-V',
		github: 'https://github.com/lucasdjt/emulateur',
		date: '23/01/2026',
		description: `Projet de 3ème année de BUT Informatique consistant à développer un émulateur RISC-V en C++.
		Il permet de charger un binaire, décoder et exécuter les instructions, gérer la mémoire et les registres,
		et propose un mode pas-à-pas avec affichage détaillé pour le debug et la validation. Projet réalisé en binôme.`,
		state: 'completed',
		experiences: 'but-info',
		screenshots: [],
		skills: [
	...
	{
		id: 'agariolike',
		path: `${PATH_LOGO}agariolike/`,
		title: 'Jeu web multijoueur client–serveur',
		github: 'https://github.com/lucasdjt/Agariolike',
		...
		screenshots: [
			...
			'gameplay_2.png',
			'replay.png',
		].map(img => `${PATH_LOGO}agariolike/${img}`),
		skills: [
	...
	},
	{
		...
		skills: [
			{ anchor: 'javaee', title: 'Java EE (JSP, JDBC, Tomcat)' },
