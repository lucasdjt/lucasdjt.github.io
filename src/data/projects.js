const PATH_LOGO = 'public/images/projects/';
...
const projects = [
    {
        ...
        date: '27/03/2025',
        description: 
        `Le dépôt Git de cette page web actuelle où vous pouvez explorer le code source et suivre l'évolution du projet.`,
        state: 'in-progress',
        experiences: 'personal',
        screenshots: ['logo.png', 'uneautreimage.png'].map(img => `${PATH_LOGO}portfolio/${img}`),
        skills: [
        ...
        oldVersions: [{
            ...
            description: 
            `L'ancienne version du portfolio`,
    ...
    },
    {
        ...
        description: 
        `Jeu développé en JavaScript, inspiré du célèbre jeu Agar.io, 
        offrant une expérience multijoueur immersive avec des fonctionnalités similaires au jeu original.`,
        state: 'completed',
        experiences: 'but-info',
        screenshots: ['accueil.png','credits.png','gameplay.png','gameplay_2.png','replay.png'].map(img => `${PATH_LOGO}hagario/${img}`),
        skills: [
    ...
    },
    {
        ...
        description: 
        `J’ai développé Dwidder, un réseau social inspiré de Twitter et Facebook, utilisant JakartaEE pour le back-end 
        ...
        state: 'completed',
        experiences: 'but-info',
        screenshots: ['accueil.jpg','arborescence.png','inscription.jpg','connexion.jpg','admin.jpg','commentaire.jpg','creerGroupe.jpg','groupe.jpg','listUser.jpg','message.jpg','modifierGroupe.jpg','parametres.jpg','profil.jpg','reaction.jpg'].map(img => `${PATH_LOGO}dwidder/${img}`),
        skills: [
    ...
    },
    {
        ...
        description: 
        `Jouez aux échecs avec cette application disponible sur PC. Utilise la méthode MVC, Java et Swing. 
        Respecte les règles officielles du jeu d'échecs et permet des parties à deux joueurs. 
        Projet entièrement réalisé en solo.`,
        state: 'paused',
        experiences: 'but-info',
        screenshots: ['start.png','selectionner.png','dameSelect.png','changementTour.png','victoire.png','sansgraphique_1.png','sans_graphique_2.png'].map(img => `${PATH_LOGO}chess/${img}`),
        skills: [
            { 'anchor': 'java', title: 'Java' },
        ...
        oldVersions: [{
            ...
            description: 
            `L'ancienne version du jeu d'échec avec seulement une interface non graphique.`,
    ...
    },
    {
        ...
        description: 
        `Ce projet propose un outil permettant de charger et d'afficher visuellement un ensemble de données variées. 
        ...
        state: 'completed',
        experiences: 'but-info',
        screenshots: ['accueil.png','projection.png','autreaffichage.png','ajoutpoint.png'].map(img => `${PATH_LOGO}classification/${img}`),
        skills: [
            { 'anchor': 'java', title: 'Java' },
    ...
    },
    {
        ...
        description: 
        `Projet pour introduire l'agilité avec des sprints de 2h durant 1 semaine, en utilisant Java et la méthode SCRUM 
        (Agile), réalisé dans une équipe de 6 personnes.`,
        state: 'completed',
        experiences: 'but-info',
        screenshots: ['presentation.jpg', 'radiateur.jpg'].map(img => `${PATH_LOGO}miniagile/${img}`),
        skills: [
            { 'anchor': 'java', title: 'Java' },
